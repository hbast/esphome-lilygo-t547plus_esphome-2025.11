...
namespace {
inline bool i2c_ok(i2c::ErrorCode err, LilygoT5_47PlusTouchscreen *ts) {
  if (err != i2c::ERROR_OK) {
...
void LilygoT5_47PlusTouchscreen::setup() {
...
void LilygoT5_47PlusTouchscreen::update_touches() {
  i2c::ErrorCode err;
...
void LilygoT5_47PlusTouchscreen::dump_config() {
