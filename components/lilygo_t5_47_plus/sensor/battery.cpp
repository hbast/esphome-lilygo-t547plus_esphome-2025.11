...
void LilygoT5_47PlusBattery::update() {
...
float LilygoT5_47PlusBattery::read_battery_voltage_() {
...
float LilygoT5_47PlusBattery::voltage_to_percent_(float voltage) const {
